...
def getPlantMasks(binrayMask, min_contour_area, bushy=True):
        # find contours
        ...
        for i in range(len(contours)):
            if cv.contourArea(contours[i]) > min_contour_area:
                ...
                if bushy : 
                    ...
                    sub_contours = splitContours(contour=contours[i], x=cn_x, y=cn_y, w=cnt_w, h=cn_h, max_coutour_height=160)
